...
const OffersSection = () => {
  const products: Product[] = [
    ...
    },
    {
      deepDetails: [{ weight: "1", price: "200" }],
      _id: "3",
      img: "https://i.imgur.com/AEEwZrJ.png",
    ...
    },
    {
      deepDetails: [{ weight: "1", price: "200" }],
      _id: "4",
      img: "https://i.imgur.com/jfEgIYi.png",
  ...
  return (
    <section className="flex flex-col gap-16 bg-foreground/10 py-12">
      <div>
        <h2 className="sm:2xl  scroll-m-20 pb-2 text-center text-primary text-xl font-semibold uppercase tracking-tight first:mt-0 md:text-3xl">
          Offers items
        </h2>
      </div>
